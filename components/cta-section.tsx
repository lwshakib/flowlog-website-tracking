        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-primary-foreground/80">
              Join thousands of teams using Flowlog to understand their users 
              and build better products. Start your 14-day free trial today.
            </p>
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Button asChild size="lg" variant="outline" className="h-12 border-primary-foreground/20 bg-transparent px-8 text-base font-semibold text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground">
                <Link href="#pricing">
                    View Pricing
                </Link>
              </Button>
