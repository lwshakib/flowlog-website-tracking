...
const features = [
  {
    ...
    description:
      "Watch your users interact with your site in real-time. See every click, scroll, and navigation event as it happens.",
    icon: Activity,
  ...
  },
  {
    ...
    description:
      "Understand the paths your users take. Our powerful flow diagrams help you identify bottlenecks and optimize conversion paths.",
    icon: Zap,
  ...
  },
  {
    name: "Privacy First",
    description:
      "Built with privacy in mind. We are fully GDPR and CCPA compliant, ensuring your users' data stays safe and anonymous.",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      "Install with a single line of code. Support for Next.js, React, Vue, and plain HTML. Get started in less than 2 minutes.",
    icon: Layout,
    ...
    <section id="features" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Everything you need to understand your users and grow your business. All in one
